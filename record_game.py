...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str,default="models/dqn_model_5200000_steps", help='Path to the trained model (optional)')
    ...
    parser.add_argument('--episodes', type=int, default=15, help='Number of episodes to record')
