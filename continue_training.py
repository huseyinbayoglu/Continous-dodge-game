...
from train import CustomEvalCallback, LrLoggingCallback, RolloutMetricsCallback, create_env, linear_lr_schedule
...
def continue_training_dqn(
    ...
    metrics_callback = RolloutMetricsCallback(log_freq=1)
        # Continue training
